...
public class PdfSHandler : IPdfService
{
    ...
    public async Task<string> GetAnswerFromPdfAsync(IFormFile pdfFile, string question)
    {
        ...
        IReadOnlyCollection<Document>? similarDocuments = await vectorCollection.GetSimilarDocuments(_embeddingModel, question, amount: 5);
